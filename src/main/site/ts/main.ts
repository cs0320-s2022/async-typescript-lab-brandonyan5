...
const listOfSuggestions = document.getElementById("suggestions") as HTMLInputElement
const firstDropdownSun = document.getElementById("sun") as HTMLInputElement
const secondDropdownMoon = document.getElementById("moon") as HTMLInputElement
const thirdDropdownRising = document.getElementById("rising") as HTMLInputElement
...
document.addEventListener("keyup", async (event) => {
  if (event.key === "1") {await updateValues("Capricorn", "Capricorn", "Capricorn");
    postAndUpdate();
  }
});
